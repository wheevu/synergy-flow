...
func (s *Server) routes() {
	...
	p.GET("/projects/:id/scenarios", s.listScenarios)
	p.POST("/projects/:id/scenarios", s.createScenario)
	p.GET("/scenarios/:id", s.getScenario)
	p.POST("/scenarios/:id/events", s.appendScenarioEvent)
	p.GET("/scenarios/:id/analysis", s.scenarioAnalysis)
	p.GET("/scenarios/:id/compare", s.compareScenario)
